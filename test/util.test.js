...
describe('Utilities', function(){
  ...
  it('should convert to bytes', function(){
    ...
    util.getBytes('1ki').should.equal(1024);
    util.getBytes('0.5ki').should.equal(512);
    util.getBytes('1Mi').should.equal(1024*1024);
    util.getBytes('1Gi').should.equal(1024*1024*1024);
    util.getBytes('  1 ki   ').should.equal(1024);
    should.not.exist(util.getBytes('break 1ki'));
  });
